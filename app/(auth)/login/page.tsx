...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[#f8fafc] py-8 px-2">
      <div className="w-[500px]">
        <Card className="bg-white shadow-lg border-0 w-full " style={{ boxShadow: '0px 4px 12px 0px rgba(0,0,0,0.05)' }}>
